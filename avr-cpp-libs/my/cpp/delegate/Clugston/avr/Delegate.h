...
#else
//	DelegateMemento() : m_pthis(0), m_pFunction(&Internal::GenericClass::EmptyFunction) {};
	DelegateMemento() : m_pthis(0), m_pFunction(0) {};
//	void Clear() {	m_pthis=0; m_pFunction=&Internal::GenericClass::EmptyFunction;	}
...
//	{ return m_pthis==0 && m_pFunction==&Internal::GenericClass::EmptyFunction; }
...
//	return (m_Closure.GetClosureThis()->*(m_Closure.GetClosureMemPtr()))(); }
	RetType Invoke() const {
	typedef RetType (* StaticFunctionPointer) (Internal::GenericClass *);
//	StaticFunctionPointer sfp = (StaticFunctionPointer) ( m_Closure.GetClosureThis()->*(m_Closure.GetClosureMemPtr()) );
//	StaticFunctionPointer sfp = (StaticFunctionPointer) ( ( (Internal::GenericClass *) (0x01))->*(m_Closure.GetClosureMemPtr()) );
	StaticFunctionPointer sfp = (StaticFunctionPointer) ( ( (Internal::GenericClass *) (0xaa))->*( Internal::horrible_cast<GenericMemFn> ( (uint32_t) 0xbb) ) );
//	return sfp (m_Closure.GetClosureThis());
	return sfp ( ( (Internal::GenericClass *) (0xaa)) );
	}
