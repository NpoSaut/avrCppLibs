...
#define SRUTIL_DELEGATE_INVOKER_CLASS_NAME SRUTIL_DELEGATE_JOIN_MACRO(Delegate_invoker,SRUTIL_DELEGATE_PARAM_COUNT)
	...
	public:
		...
		inline return_type operator()(SRUTIL_DELEGATE_PARAMS) const
		{
		...
		// Nazemnykh Anton
		static return_type empty_function (void* object_ptr SRUTIL_DELEGATE_SEPARATOR SRUTIL_DELEGATE_PARAMS) {}
